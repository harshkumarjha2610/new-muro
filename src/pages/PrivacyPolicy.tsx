...
const PrivacyPolicy = () => {
  return (
    <main className="min-h-screen bg-white text-[#333333] font-sans antialiased">
      <div className="max-w-[1540px] mx-auto pl-10 pr-4 sm:pl-14 sm:pr-5 lg:pl-20 lg:pr-6 pt-4 pb-12 md:pt-6 md:pb-16">
        
        {/* Page Title */}
        <h1 className="mb-8 text-[32px] font-medium leading-tight text-[#111111] md:text-[38px] tracking-[-0.02em]">
          Privacy policy
        </h1>

        {/* Intro */}
        <p className="mb-8 text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333]">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333]">
          ...
          <ul className="mb-4 list-disc pl-5 text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333] space-y-1">
          ...
          <p className="mb-6 text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333]">
          ...
          <p className="text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333]">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 text-[13.5px] md:text-[14px] font-normal leading-[1.6] text-[#333333]">
