...
const fetchPostcardRows =
  async (): Promise<PostcardProduct[]> => {
    const response = await fetch(
      `${API_BASE}/postcards`,
      {
        headers: {
      ...
      <section className="mx-auto max-w-[1320px] px-5 pb-8 pt-5 md:px-7 md:pb-10 md:pt-6 lg:px-8">
        <div className="relative grid gap-4 md:min-h-[72px] md:grid-cols-[0.85fr_1.15fr] md:items-start">
          ...
          >
            ...
            Postcards from MURO Poster. Explore
            unique designs created to add
            personality, creativity and visual
            impact to modern spaces.
          </p>
        </div>
      </section>
